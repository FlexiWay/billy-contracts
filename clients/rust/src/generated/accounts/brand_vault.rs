...
impl BrandVault {
    ...
    ///   0. `BrandVault::PREFIX`
    ///   1. mint (`Pubkey`)
    pub const PREFIX: &'static [u8] = "brand-vault".as_bytes();
    ...
    pub fn create_pda(
        ...
        solana_program::pubkey::Pubkey::create_program_address(
            &["brand-vault".as_bytes(), mint.as_ref(), &[bump]],
    ...
    pub fn find_pda(mint: &Pubkey) -> (solana_program::pubkey::Pubkey, u8) {
        solana_program::pubkey::Pubkey::find_program_address(
            &["brand-vault".as_bytes(), mint.as_ref()],
            &crate::LMAOFUN_BONDING_CURVE_ID,
        )
    }
...
impl<'a> TryFrom<&solana_program::account_info::AccountInfo<'a>> for BrandVault {
